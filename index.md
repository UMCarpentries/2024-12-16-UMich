...
humandate: "December 16-17, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 4:30 pm EST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2024-12-16      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2024-12-17        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Irene Morse", "Mark Ciechanowski", "Lisa Levinson"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Cindy Sopko", "Gregory Johnson"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2024-12-16-UMich  # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
googleform: "https://forms.gle/6m6a5LkQ6bqDopy69" # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
...
<a href="https://forms.gle/6m6a5LkQ6bqDopy69">Registration Link</a> You will need to sign in to your Google account to view the registration form.
